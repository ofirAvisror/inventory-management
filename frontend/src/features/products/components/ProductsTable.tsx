    ...
    return (
      <Alert variant="error" title={t("products.table.errorTitle")}>
        <button
          type="button"
          onClick={onRetry}
          className="mt-2 inline-flex h-9 items-center rounded-lg border border-red-300 px-3 text-sm font-medium text-red-800 transition hover:bg-red-100 dark:border-red-700 dark:text-red-200 dark:hover:bg-red-950/60"
        >
